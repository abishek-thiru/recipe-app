...
export default function RecipeCard({ recipe }) {
  return (
    <div className="bg-white border border-gray-200 rounded-[25px] p-8 shadow-md hover:shadow-lg transition-shadow duration-200 m-4 h-[200px] w-[300px] md:w-[350px] lg:w-[300px]">
